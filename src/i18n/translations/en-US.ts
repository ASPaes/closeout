...
const enUS: Record<TranslationKey, string> = {
  ...
  consumer_qr_active_orders: "Active Orders",
  consumer_qr_no_active: "No active orders",
  consumer_qr_no_active_desc: "Your paid orders will appear here",
  consumer_qr_make_order: "Place order",
  consumer_qr_view_qr: "View QR Code",
  consumer_qr_not_found: "Order not found",
  ...
  gef_comanda_caixa: "Comanda (POS)",
  gef_comanda_caixa_sublabel: "received outside gateway",
  gef_comanda_caixa_dinheiro: "Cash",
  gef_comanda_caixa_pix: "PIX",
  gef_comanda_caixa_credit: "Credit",
  gef_comanda_caixa_debit: "Debit",
  gef_no_comanda_caixa_breakdown: "No payment breakdown",
  gef_unsettled_comandas: "Unsettled comandas",
  gef_unsettled_card_number: "Comanda",
  gef_unsettled_consumer_name: "Customer",
  gef_unsettled_consumer_phone: "Phone",
  gef_unsettled_consumer_cpf: "CPF",
  gef_unsettled_value: "Value",
  gef_open_comandas_warning: "There are {count} open comanda(s). Close the event to consolidate unsettled amounts.",
