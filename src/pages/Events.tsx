...
export default function Events() {
  ...
  const openCreate = () => {
    setEditing(null);
    setForm({ name: "", venue_id: venues[0]?.id || "", description: "", start_at: "", end_at: "", status: "draft" });
    setSheetOpen(true);
  };
            ...
            <SheetContent className="sm:max-w-md">
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2"><Label>Start</Label><Input type="datetime-local" value={form.start_at} onChange={(e) => setForm({ ...form, start_at: e.target.value })} /></div>
                  <div className="space-y-2"><Label>End</Label><Input type="datetime-local" value={form.end_at} onChange={(e) => setForm({ ...form, end_at: e.target.value })} /></div>
                </div>
                <div className="space-y-2">
                  <Label>Status</Label>
