    ...
    )},
    {
      ...
      render: (r) => (
        <div className="flex gap-1 justify-end">
          ...
          {r.status !== "draft" && <Button size="sm" variant="ghost" onClick={() => navigate(`/gestor/eventos/${r.id}/fechamento`)} title={t("gef_view_closing")}><FileText className="h-4 w-4 text-info" /></Button>}
