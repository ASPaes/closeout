...
const caixaItems: { titleKey: TranslationKey; url: string; icon: any }[] = [
  ...
  { titleKey: "caixa_closing", url: "/caixa/fechamento", icon: Lock },
];
...
function SidebarNavItem({ item, collapsed, isActive, t }: { item: typeof caixaItems[0]; collapsed: boolean; isActive: boolean; t: (key: TranslationKey) => string }) {
  const content = (
        ...
        {!collapsed ? (
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground leading-none mt-0.5">{t("caixa_panel")}</p>
            </div>
          </div>
        ) : (
