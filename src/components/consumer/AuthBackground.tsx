...
`;
  ...
  return (
    <div className="relative min-h-[100dvh]">
      {/* Background layers - FIXED para parallax, sangra nas safe areas */}
      <div
      ...
      >
        {/* Gradients */}
        <div className="absolute inset-0" style={{ background: `radial-gradient(ellipse 80% 60% at 50% 0%, hsla(24,90%,18%,0.9), transparent 60%), radial-gradient(ellipse 100% 80% at 50% 100%, hsla(24,80%,12%,0.8), transparent 70%), radial-gradient(ellipse 60% 50% at 0% 50%, hsla(24,60%,6%,0.6), transparent 60%), linear-gradient(180deg, #0a0806 0%, #1a0e04 50%, #0a0806 100%)` }} />
        {/* Noise */}
      ...
      {/* Conteúdo - NO FLUXO NORMAL do documento */}
